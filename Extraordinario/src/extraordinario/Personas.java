...
public class Personas extends javax.swing.JFrame {
     ...
     */
    ArrayList<Alumnos> ver=new ArrayList<Alumnos>();
    public Personas() {
        initComponents();
    }
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        Alumnos alumnos=new Alumnos(txtNombre.getText(),txtApellidos.getText(),txtNumPer.getText());
        ver.add(alumnos);
    ...
    public void mostrar(){
        String matriz [][]=new String[ver.size()][3];
        for (int i = 0; i < ver.size(); i++){
            matriz[i][0]=ver.get(i).getNumPer();
            matriz[i][1]=ver.get(i).getNombre();
            matriz[i][2]=ver.get(i).getApellidos();
